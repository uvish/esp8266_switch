...
//digitalWrite(Pump, value);
  ...
  if(value == HIGH) {
    ...
    client.print("<h1 class=\"status_off\">OFF</h1></div>");
     client.println("<div class=\"lower half\">");
